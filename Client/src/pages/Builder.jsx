...
function Builder({ user, setUser }) {
  ...
  return (
    <div className="min-h-screen app-bg px-4 py-8">
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          <h2 className="text-3xl font-bold text-main">Assistant Builder</h2>
          <p className="text-muted mt-1"> Customize your virtual assistant</p>
        </div>
  ...
  <script src="${CLIENT_URL}/assistant.js" data-user-id="${user?._id}"></script>
              ...
              <p className="text-sm font-medium text-main mb-3 mt-3">
                Embed Code
              </p>
            </div>
            ...
            <div className="relative">
              ...
              <button
                ...
                className="absolute top-4 right-4 w-10 h-10 rounded-xl surface flex items-center justify-center"
              >
                <FiCopy />
              </button>
            </div>
        ...
        {editAssistant && (
          <div className="space-y-6">
            ...
            <div className="surface rounded-3xl border border-transparent shadow-sm p-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <input
                  ...
                  className="border border-transparent rounded-2xl px-4 py-3 bg-[rgba(255,255,255,0.02)] text-main placeholder:text-muted"
            ...
            <button
              ...
              className="w-full h-14 rounded-2xl btn-primary font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading
                ? "Saving..."
