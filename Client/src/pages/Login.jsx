      ...
      <div className="max-w-7xl mx-auto px-6 py-16 lg:py-24">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <button
              onClick={handleLogin}
              className="mt-10 h-16 px-8 rounded-2xl btn-primary text-lg font-semibold flex items-center gap-4 hover:scale-[1.02] transition cursor-pointer"
            >
            ...
            <div className="relative rounded-[40px] border border-transparent surface shadow-[0_20px_80px_rgba(0,0,0,0.6)] p-8 overflow-hidden">
              ...
              <div className="mt-10 space-y-5">
                {FEATURES.map(({ icon, title, desc }, index) => (
                  <div
                    key={index}
                    className="flex gap-5 rounded-3xl border border-transparent surface p-5"
                  >
